...
/* harmony default export */ var svgRenderervue_type_script_lang_js_ = ({
  ...
  name: 'svg-renderer',
  props: ['size', 'nodes', 'noNodes', 'selected', 'linksSelected', 'links', 'nodeSize', 'padding', 'fontSize', 'strLinks', 'linkWidth', 'nodeLabels', 'linkLabels', 'labelOffset', 'nodeSym', 'zoomEnabled', 'controlIconsEnabled', 'fit', 'panEnabled', 'dblClickZoomEnable', 'mouseWheelZoomEnabled', 'preventMouseEventsDefault', 'contain', 'center', 'viewportSelector', 'zoomScaleSensitivity', 'minZoom', 'maxZoom', 'refreshRate'],
  computed: {
...
/* harmony default export */ var vue_d3_networkvue_type_script_lang_js_ = ({
  ...
  render: function render(createElement) {
    ...
    var bindProps = ['size', 'nodes', 'links', 'selected', 'linksSelected', 'strLinks', 'linkWidth', 'nodeLabels', 'linkLabels', 'fontSize', 'labelOffset', 'offset', 'padding', 'nodeSize', 'noNodes', 'zoomEnabled', 'controlIconsEnabled', 'fit', 'panEnabled', 'dblClickZoomEnable', 'mouseWheelZoomEnabled', 'preventMouseEventsDefault', 'contain', 'center', 'viewportSelector', 'zoomScaleSensitivity', 'minZoom', 'maxZoom', 'refreshRate'];
